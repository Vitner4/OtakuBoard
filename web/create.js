...
// Предпросмотр загружаемой шапки
document.getElementById('header-image').addEventListener('change', function(event) {
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            ...
            // Добавляем изображение в блок предпросмотра
        ...
        // Если файл не выбран
        preview.innerHTML = '<p>Предпросмотр изображения шапки появится здесь после выбора файла.</p>';
    }
});
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    fileInput.addEventListener('change', function() {
        ...
        if (!file) {
            ...
            previewContainer.innerHTML = '<p>Предпросмотр обложки появится здесь</p>';
            return;
        }
        ...
        reader.onload = function(e) {
            ...
            img.onload = function() {
                ...
                // console.log('Base64 обложки:', img.src);
            };

            // Ошибка при создании/отображении изображения
            img.onerror = function() {
                previewContainer.innerHTML = '<p>Не удалось загрузить изображение</p>';
            };
        };
...
// Предпросмотр обложки по URL ссылке
document.addEventListener('DOMContentLoaded', () => {
...
function removeCover(){
    ...
    if (previewContainer) previewContainer.innerHTML = '<p>Предпросмотр обложки появится здесь</p>';
}
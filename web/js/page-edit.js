// Type: обработка страницы page-edit.html, редактирование карточки
// Author: Vitner4
...
const coverLinkInput = document.getElementById('cover-link'); // Обложка по ссылке 
...
// Получение данных карточки из URL
...
let selectedStar = 0; // Выбранная звезда рейтинга 
...
// ==============================================
// Метод загрузки карточки по ID и её отображение 
// ==============================================
...
// ==============================
// Методы редактирования карточки
// ==============================

// Type: обработка и создание карточек на frontend
// Author: Vitner4
    ...
    if(document.getElementById('name').value.trim().length === 0){
        ...
        if(checkInvalidChars(document.getElementById('name').value) == true){
            ...
            if (selectedFormat == "file") {
                ...
                const base64 = await fileToBase64(file, 'status'); // Преобразуем файл в строку base64

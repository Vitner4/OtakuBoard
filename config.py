...
# ============================================
# Функции взаимодействия с файлом конфигурации
# ============================================
...
# Функция получения стандартных значений конфигурации
def get_default_config_value(section, key):
    return default_config_data[section][key]

# ========================================================
# Функции взаимодействия с файлом конфигурации на Frontend
# ========================================================

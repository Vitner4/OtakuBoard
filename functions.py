 # !! Заменен на dataManager.py. Оставлен для дальнейшей разработки и добавления новых функций, связанных с карточками в dataManager.py. 
...
# как глобальный список и написать функции по ЕГО сортировке и выводе на основе этой сортировки. Данные для сортировки
...
def outputAllData(fileIndex):
    ...
    if len(files) == 0:
        ...
        # Проверка на подлинность и вывод данных
...
# Функция поиска файлов и получение их количества (для js)
@eel.expose
def getDataLength():
    # Поиск данных
    files = os.listdir("data-test")
